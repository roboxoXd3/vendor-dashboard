        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="border-t pt-4">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="text-sm font-medium text-gray-900">Size Chart Visibility</h4>
                <p className="text-sm text-gray-500">Show size chart button on product page</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    console.log('Size chart toggle changed:', { checked: e.target.checked, newValue });
                    handleInputChange({
                      target: {
            ...
            {/* Debug info */}
            <p className="text-xs text-gray-500 mt-1">
              Debug: size_chart_override = "{formData.size_chart_override || 'undefined'}"
            </p>
          </div>
        </div>
      </div>
