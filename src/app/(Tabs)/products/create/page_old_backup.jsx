...
export default function CreateProductPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!vendor?.id) {
      alert('Vendor information not found. Please try logging in again.')
      return
    }
    ...
    try {
      ...
      console.log('✅ Product created successfully, images confirmed as permanent')
              ...
              <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <MainImageUpload
                        onUploadSuccess={(urls) => {
                          console.log('🖼️ Images uploaded successfully:', urls)
                          console.log('🖼️ URLs type:', typeof urls, 'Is array:', Array.isArray(urls))
                          const urlArray = Array.isArray(urls) ? urls : [urls]
                          console.log('🖼️ Processing URLs:', urlArray)
                          setFormData(prev => {
                            const newImages = [...prev.images, ...urlArray]
                            console.log('🖼️ Updated images array:', newImages)
                            return {
                              ...prev,
                              images: newImages
                            }
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <VideoUpload
                    ...
                    vendorId={vendor?.id}
                    productId={null} // No product ID for new products
                  />
