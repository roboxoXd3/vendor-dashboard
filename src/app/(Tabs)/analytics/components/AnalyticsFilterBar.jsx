...
export default function AnalyticsFilterBar({ filters, onFiltersChange }) {
    ...
    <div className="flex flex-wrap md:flex-nowrap items-start md:items-center justify-between gap-4">
      ...
      <button
        ...
        onClick={() => {
          ...
          const reportData = {
            reportType: 'Analytics Statement',
          ...
          link.href = url;
          link.download = `analytics-statement-${new Date().toISOString().split('T')[0]}.csv`;
